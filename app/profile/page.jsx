...
const Profile = async () => {
    ...
    if (!userProperties) {
        return (<h1>Vous n'avez aucun propriétés.</h1>)
    }
    ...
    return (
        <section className="bg-blue-50">
            <div className="container m-auto py-24">
                ...
                >
                    <h1 className="text-3xl font-bold mb-4">Votre Compte</h1>
                    <div className="flex flex-col md:flex-row">
                        <div className="md:w-1/4 mx-20 mt-10">
                            ...
                            <h2 className="text-2xl mb-4">
                                <span className="font-bold block">Nom: </span> {user.name}
                            </h2>
                        ...
                        <div className="md:w-3/4 md:pl-4">
                            <h2 className="text-xl font-semibold mb-4">Vos propritétés</h2>
